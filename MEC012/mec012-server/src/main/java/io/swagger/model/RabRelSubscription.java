...
public class RabRelSubscription  implements OneOfInlineSubscription {
  @JsonProperty("_links")
  ...
  public RabRelSubscription _links(CaReconfSubscriptionLinks _links) {
    this._links = _links;
    return this;
  }
  ...
  **/
  ...
  public RabRelSubscription callbackReference(String callbackReference) {
  ...
  **/
  ...
  public RabRelSubscription expiryDeadline(TimeStamp expiryDeadline) {
  ...
  **/
  ...
  public RabRelSubscription filterCriteriaQci(RabModSubscriptionFilterCriteriaQci filterCriteriaQci) {
  ...
  **/
  ...
  public RabRelSubscription subscriptionType(String subscriptionType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Shall be set to \"RabRelSubscription\".")
      @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RabRelSubscription rabRelSubscription = (RabRelSubscription) o;
    return Objects.equals(this._links, rabRelSubscription._links) &&
        Objects.equals(this.callbackReference, rabRelSubscription.callbackReference) &&
        Objects.equals(this.expiryDeadline, rabRelSubscription.expiryDeadline) &&
        Objects.equals(this.filterCriteriaQci, rabRelSubscription.filterCriteriaQci) &&
        Objects.equals(this.subscriptionType, rabRelSubscription.subscriptionType);
  }
  ...
  public String toString() {
    ...
    sb.append("class RabRelSubscription {\n");
