...
public class S1BearerSubscription implements OneOfInlineSubscription {
  @SerializedName("S1BearerSubscriptionCriteria")
  ...
  **/
  @Schema(required = true, description = "URI selected by the service consumer, to receive notifications on the subscribed RNIS information. This shall be included in the request and response.")
   ...
   * @return eventType
  **/
  @Schema(required = true, description = "Description of the subscribed event. The event is included both in the request and in the response. \\nFor the eventType, the following values are currently defined: <p>0 = RESERVED. <p>1 = S1_BEARER_ESTABLISH. <p>2 = S1_BEARER_MODIFY. <p>3 = S1_BEARER_RELEASE.")
  ...
  **/
  @Schema(required = true, description = "Shall be set to \"S1BearerSubscription\".")
